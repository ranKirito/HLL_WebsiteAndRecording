...
func (x *KillEvent) GetTime() string {
	if x != nil {
		return x.Time
	}
	return ""
...
type Snapshot struct {
	...
	Kills         []*KillEvent    `protobuf:"bytes,5,rep,name=kills,proto3" json:"kills,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Snapshot) GetKills() []*KillEvent {
	if x != nil {
		return x.Kills
	}
	return nil
...
const file_record_record_proto_rawDesc = "" +
	"\n" +
	"\x13record/record.proto\x12\x06record\x1a\x1fgoogle/protobuf/timestamp.proto\"\x7f\n" +
	...
	"\rDeltaSnapshot\x12-\n" +
	"\aplayers\x18\x01 \x03(\v2\x13.record.PlayerDeltaR\aplayers\"Y\n" +
	"\tKillEvent\x12\x1b\n" +
	"\tkiller_id\x18\x01 \x01(\x05R\bkillerId\x12\x1b\n" +
	"\tvictim_id\x18\x02 \x01(\x05R\bvictimId\x12\x12\n" +
	"\x04time\x18\x03 \x01(\tR\x04time\"\x88\x02\n" +
	"\bSnapshot\x12\x14\n" +
	...
	"\x0edelta_snapshot\x18\x04 \x01(\v2\x15.record.DeltaSnapshotH\x00R\rdeltaSnapshot\x12'\n" +
	"\x05kills\x18\x05 \x03(\v2\x11.record.KillEventR\x05killsB\x06\n" +
	"\x04data\"h\n" +
	"\tMatchData\x12+\n" +
...
var file_record_record_proto_goTypes = []any{
	...
	(*KillEvent)(nil),             // 6: record.KillEvent
	(*Snapshot)(nil),              // 7: record.Snapshot
	(*MatchData)(nil),             // 8: record.MatchData
	nil,                           // 9: record.MatchHeader.PlayersEntry
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_record_record_proto_depIdxs = []int32{
	10, // 0: record.MatchHeader.start_time:type_name -> google.protobuf.Timestamp
	10, // 1: record.MatchHeader.end_time:type_name -> google.protobuf.Timestamp
	9,  // 2: record.MatchHeader.players:type_name -> record.MatchHeader.PlayersEntry
	...
	10, // 5: record.Snapshot.timestamp:type_name -> google.protobuf.Timestamp
	...
	6,  // 8: record.Snapshot.kills:type_name -> record.KillEvent
	1,  // 9: record.MatchData.header:type_name -> record.MatchHeader
	7,  // 10: record.MatchData.snapshots:type_name -> record.Snapshot
...
func file_record_record_proto_init() {
	...
	file_record_record_proto_msgTypes[3].OneofWrappers = []any{}
	file_record_record_proto_msgTypes[7].OneofWrappers = []any{
